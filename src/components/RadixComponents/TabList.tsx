...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'naxatw-ring-offset-background focus-visible:naxatw-ring-ring naxatw-mt-2 focus-visible:naxatw-outline-none focus-visible:naxatw-ring-2 focus-visible:naxatw-ring-offset-2',
      className,
    )}
    {...props}
  />
