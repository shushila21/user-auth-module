...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      showOutsideDays
      onSelect={onSelect}
      className="naxatw-m-0 naxatw-w-fit naxatw-rounded-lg naxatw-p-[2px]"
      classNames={{
        months:
        ...
        month: 'naxatw-m-[0px]',
        caption:
          'naxatw-flex naxatw-justify-between naxatw-pt-1 naxatw-px-2 naxatw-relative naxatw-items-center',
        ...
        day_selected:
          'hover:naxatw-blue-400 !naxatw-bg-blue-500 naxatw-b-2 !naxatw-text-white',
